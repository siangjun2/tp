...
public class MarkCommandParserTest {
    ...
    public void parse_invalidIndex_failure() {
        // Depending on ParserUtil, this may emit a specific MESSAGE_INVALID_INDEX; accept any ParseException.
        assertThrows(ParseException.class, () -> parser.parse("0 w/W26-2025"));
        assertThrows(ParseException.class, () -> parser.parse("-5 w/W26-2025"));
        assertThrows(ParseException.class, () -> parser.parse("abc w/W26-2025"));
    }

    @Test
    public void parse_invalidWeek_failure() {
        String input = "1 w/not-a-week";
        ParseException ex = assertThrows(ParseException.class, () -> parser.parse(input));
        // MarkCommandParser should surface WeeklyAttendance constraints for invalid week format
