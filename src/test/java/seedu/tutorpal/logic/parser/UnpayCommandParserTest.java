...
public class UnpayCommandParserTest {
    ...
    public void parse_validPositiveIndex_success() throws Exception {
        ...
        UnpayCommand result = parser.parse(input);

        UnpayCommand expected = new UnpayCommand(Index.fromOneBased(1), YearMonth.of(2024, 1));
    ...
    public void parse_validIndexWithWhitespace_success() throws Exception {
        ...
        UnpayCommand expected = new UnpayCommand(Index.fromOneBased(2), YearMonth.of(2024, 1));
        assertEquals(expected, result);
    }
    ...
    public void parse_missingIndex_failure() {
        ...
        assertEquals(String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, UnpayCommand.MESSAGE_USAGE),
                ex.getMessage());
    }
    ...
    public void parse_validMonthMaximum_success() throws Exception {
        ...
        UnpayCommand expected = new UnpayCommand(Index.fromOneBased(1), YearMonth.of(2024, 12));
        assertEquals(expected, result);
    }
    ...
    public void parse_validMonthMidRange_success() throws Exception {
        ...
        UnpayCommand expected = new UnpayCommand(Index.fromOneBased(1), YearMonth.of(2024, 6));
        assertEquals(expected, result);
    }
    ...
    public void parse_validYear2000_success() throws Exception {
        ...
        UnpayCommand expected = new UnpayCommand(Index.fromOneBased(1), YearMonth.of(2000, 1));
        assertEquals(expected, result);
    }
