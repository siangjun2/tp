...
/**
 * Tests for DelpayCommandParser.
 */
public class DelpayCommandParserTest {

    private final DelpayCommandParser parser = new DelpayCommandParser();
    ...
    public void parse_validPositiveIndex_success() throws Exception {
        ...
        DelpayCommand result = parser.parse(input);

        DelpayCommand expected = new DelpayCommand(Index.fromOneBased(1), YearMonth.of(2024, 1));
    ...
    public void parse_validIndexWithWhitespace_success() throws Exception {
        ...
        DelpayCommand expected = new DelpayCommand(Index.fromOneBased(2), YearMonth.of(2024, 1));
        assertEquals(expected, result);
    }
    ...
    public void parse_missingIndex_failure() {
        ...
        assertEquals(String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, DelpayCommand.MESSAGE_USAGE),
                ex.getMessage());
    }
    ...
    public void parse_validMonthMaximum_success() throws Exception {
        ...
        DelpayCommand expected = new DelpayCommand(Index.fromOneBased(1), YearMonth.of(2024, 12));
        assertEquals(expected, result);
    }
    ...
    public void parse_validMonthMidRange_success() throws Exception {
        ...
        DelpayCommand expected = new DelpayCommand(Index.fromOneBased(1), YearMonth.of(2024, 6));
        assertEquals(expected, result);
    }
    ...
    public void parse_validYear2000_success() throws Exception {
        ...
        DelpayCommand expected = new DelpayCommand(Index.fromOneBased(1), YearMonth.of(2000, 1));
        assertEquals(expected, result);
    }
    ...
    public void parse_monthZero_failure() {
        ...
        ParseException ex = assertThrows(ParseException.class, () -> parser.parse(input));
        assertEquals("Invalid month format. Use MM-yyyy, e.g., 01-2024", ex.getMessage());
    }
